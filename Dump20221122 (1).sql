...
--
-- Host: localhost    Database: spa_db1
-- ------------------------------------------------------
...
INSERT INTO `paciente` VALUES (2,'Angel Jesus','Zorrilla','whoangel.agl@gmail.com',10,'dolor de espalda'),(4,'Israel','Manzano Sanchez','isra@itoaxaca.edu.mx',20,'dolor de espalda');
...
INSERT INTO `paciente_terapeuta` VALUES (1,2,2,2,540),(2,2,2,4,720),(3,2,3,5,810),(4,4,3,4,640);
...
CREATE TABLE `reserva` (
  ...
  `pk_paciente` int DEFAULT NULL,
  `fecha` datetime DEFAULT NULL,
  `status_pago` tinyint DEFAULT NULL,
  PRIMARY KEY (`id_reserva`),
  KEY `pk_paciente_idx` (`pk_paciente`),
  CONSTRAINT `pk_paciente` FOREIGN KEY (`pk_paciente`) REFERENCES `paciente` (`id_paciente`)
...
INSERT INTO `reserva` VALUES (1,2,'2022-10-10 15:12:00',1),(2,2,'2022-12-31 15:30:21',0),(3,2,'2022-12-31 15:30:21',0),(4,2,'2022-12-31 15:30:21',0),(5,2,'2022-12-31 15:30:21',0),(6,4,'2022-12-31 15:30:21',0);
...
-- Dump completed on 2022-11-22 22:45:31
